...
@Table(
        name = "movie_reviews",
        uniqueConstraints = @UniqueConstraint(name = "uk_movie_review_account", columnNames = {"movie_id", "account_id"})
)
public class MovieReview {
    ...
    public Account getModeratedBy() {
        return moderatedBy;
    }

    public void setModeratedBy(Account moderatedBy) {
